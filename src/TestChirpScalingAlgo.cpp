...
int main(int argc, char *argv[])
{
    ...
    std::cout << "Time taken for saving: "
              << duration.count() / 1e6
              << " seconds" << std::endl;
    ...
    // save_mat_to_npy_(azimuth_fft_out, "./result/azimuth_fft_out.npy");
    // save_mat_to_npy_(chirp_scaling_out, "./result/chirp_scaling_out.npy");
    // save_mat_to_npy_(range_fft_out, "./result/range_fft_out.npy");
    // save_mat_to_npy_(second_phase_func_out_out, "./result/second_phase_func_out.npy");
    // save_mat_to_npy_(range_ifft_out, "./result/range_ifft_out.npy");
    // save_mat_to_npy_(third_phase_func_out, "./result/third_phase_func_out.npy");
    // save_mat_to_npy_(csa_out, "./result/csa_out.npy");
    ...
    // save_mat_to_npy_(csa_out, "./result/csa_out.npy");
    // save_mat_to_npy_(inverse_csa_out, "./result/inverse_csa_out.npy");
