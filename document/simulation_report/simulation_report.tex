...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../../diagram/drawio/sim_flow.png}
    \caption{Simulation flow overview.}
    \label{fig:sim_flow}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../diagram/drawio/image_to_echo.png}
        \caption{Image-to-echo conversion.}
        \label{fig:image_to_echo}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../diagram/drawio/multi_point_target.png}
        \caption{Multi-point target model.}
        \label{fig:multi_point_target}
    \end{subfigure}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{../../diagram/perf_metric/tsoying_naval_base/golden.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../diagram/perf_metric/tsoying_naval_base/result_csa.png}
        \caption{Result (threshold $= 0$).}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../diagram/perf_metric/tsoying_naval_base/result_threshold.png}
        \caption{Result (threshold $= 2 \cdot 10^5$).}
    \end{subfigure}
    \caption{CSA imaging results.}
\end{figure}

\input{performance_metrics_table}
