...
&= \sqrt{H^2+G^2+2Gd_i+d_i^2}-R_0 && \\
&= \sqrt{R_0^2+2Gd_i+d_i^2}-R_0 && \text{// } R_0^2=H^2+G^2 \\
&= R_0\sqrt{1+\frac{2Gd_i+d_i^2}{R_0^2}}-R_0 &&  \\
&\approx R_0\left(1+\frac{1}{2}\cdot\frac{2Gd_i+d_i^2}{R_0^2}\right)-R_0 && \text{// Taylor expansion approx.} \\
&= \frac{2Gd_i+d_i^2}{2R_0} &&  \\
&\approx \frac{Gd_i}{R_0} && \text{// } d_i\ll G \\
&\approx d_i && \text{// } G \approx R_0 \\
&\rightarrow R_0^{'} \approx R_0+d_i && 
\end{aligned}
$$
